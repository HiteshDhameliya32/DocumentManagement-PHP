        ...
        <div class="relative">
            <div class="md:p-10 p-6 flex items-center justify-center sm:justify-between absolute w-full flex-wrap gap-5">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <p class="lg:bg-white/10 bg-primary text-white p-3.5 rounded-lg">Don't have an account? <a href="signin-cover.php" class="font-semibold underline underline-offset-4">Sign Up for Free</a></p>
                </div>
            </div>
            <div class="min-h-screen place-content-center flex">
                <div class="flex w-full">
                        ...
                        <div class="max-w-[500px] mx-auto w-full">
                            ...
                            <form class="mt-[60px] space-y-5">
                                ...
                                <div class="flex items-center gap-2 justify-between flex-wrap">
                                    ...
                                    <span>
                                        <a href="forgot-pw-cover.php" class="hover:text-primary duration-300">Forgot Password?</a>
                                    </span>
                                </div>
                                <div class="!mt-[50px]">
                            ...
                            <div class="flex items-center gap-2.5 mt-[30px]">
                                <span class="flex-auto">
                                    <img src="assets/images/left-border.png" alt="">
                                </span>
                                <span class="shrink-0 text-gray">OR</span>
                                <span class="flex-auto">
                                    <img src="assets/images/right-border.png" alt="">
                                </span>
                            </div>
                    ...
                    <div class="hidden lg:flex w-1/2 bg-primary flex-col py-[132px] justify-center bg-[url('../images/bg-cover.png')] bg-cover bg-no-repeat bg-center">
                        <div>
                            <img src="assets/images/login-cover.png" class="mx-auto" alt="">
