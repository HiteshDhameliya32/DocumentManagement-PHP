        ...
        <div class="relative">
            <div class="md:p-10 p-6 flex items-center justify-center sm:justify-between w-full flex-wrap gap-5">
                ...
                <div class="flex items-center gap-5">
                    ...
                    <a href="login.php" class="rounded-lg capitalize flex items-center gap-2.5 text-success">
                        <svg width="24" height="24" class="inline-block" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="min-h-[calc(100vh-192px)] p-7 flex justify-center items-center">
                <div
                    ...
                    <form class="mt-[60px] space-y-5" action="Controller/forgot_password.php" method="post">
                        <div class="relative">
