...
<?php $activeMenu = 'social'; $activeItem = 'compose'?>
                                            ...
                                            <div class="flex items-center gap-6">
                                                ...
                                                <div class="relative">
                                                    <div class="overflow-visible relative border-gray/20 border-2 rounded-full px-3 py-2.5 flex items-center gap-6">
                                                        <img class="absolute -left-2 top-1/2 -translate-y-1/2 w-9 h-9 rounded-full" src="assets/images/avatar-3.png">
                                            ...
                                            <button class="w-full duration-300 p-5" @click="selectedMail = !selectedMail">
                                                <div class="flex items-start gap-3.5">
                                                    <div class="flex items-center gap-2.5 shrink-0">
                                                        ...
                                                        <img src="assets/images/avatar-3.png" class="w-[42px] h-[42px] rounded-full" alt="">
                                                    </div>
                                            ...
                                            <button class="w-full duration-300 p-5" @click="selectedMail = !selectedMail">
                                                <div class="flex items-start gap-3.5">
                                                    <div class="flex items-center gap-2.5 shrink-0">
                                                        ...
                                                        <img src="assets/images/avatar-13.png" class="w-[42px] h-[42px] rounded-full" alt="">
                                                    </div>
                                                    <div class="text-left flex-1">
                                                        <div class="flex items-center gap-1 justify-between">
                                            ...
                                            <button class="w-full duration-300 p-5" @click="selectedMail = !selectedMail">
                                                <div class="flex items-start gap-3.5">
                                                    <div class="flex items-center gap-2.5 shrink-0">
                                                        ...
                                                        <img src="assets/images/avatar-10.png" class="w-[42px] h-[42px] rounded-full" alt="">
                                                    </div>
                                                    <div class="text-left flex-1">
                                                        <div class="flex items-center gap-1 justify-between">
                                            ...
                                            <button class="w-full duration-300 p-5" @click="selectedMail = !selectedMail">
                                                <div class="flex items-start gap-3.5">
                                                    <div class="flex items-center gap-2.5 shrink-0">
                                                        ...
                                                        <img src="assets/images/avatar-11.png" class="w-[42px] h-[42px] rounded-full" alt="">
                                                    </div>
                                                    <div class="text-left flex-1">
                                                        <div class="flex items-center gap-1 justify-between">
                                            ...
                                            <button class="w-full duration-300 p-5" @click="selectedMail = !selectedMail">
                                                <div class="flex items-start gap-3.5">
                                                    <div class="flex items-center gap-2.5 shrink-0">
                                                        ...
                                                        <img src="assets/images/avatar-2.png" class="w-[42px] h-[42px] rounded-full" alt="">
                                                    </div>
                                                    <div class="text-left flex-1">
                                                        <div class="flex items-center gap-1 justify-between">
                                                ...
                                                <div class="flex items-center gap-2.5">
                                                    ...
                                                    <span class="flex items-stretch border-2 border-gray/10 rounded-full overflow-hidden">
                                                        ...
                                                        <div class="flex items-center gap-2.5 px-3">
                                                            <img src="assets/images/avatar-3.png" class="h-5 rounded-full" alt="">
