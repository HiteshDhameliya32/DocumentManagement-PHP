...
<body x-data="main" class="font-inter text-base antialiased font-medium relative vertical" :class="[ $store.app.sidebar ? 'toggle-sidebar' : '', $store.app.fullscreen ? 'full' : '',$store.app.mode]">
                        ...
                        <div class="grid grid-cols-1">
                            <div>
                                <ul class="font-semibold text-lightgray flex items-center gap-4 sm:gap-[30px] gap-y-4 whitespace-nowrap overflow-auto">
                                    ...
                                    <li>
                                        <a href="ecommerce.php" class="text-dark dark:text-white duration-300">Accounts</a>
                                    </li>
                                    <li>
                                        <a href="payment.php" class="hover:text-dark duration-300 dark:hover:text-white">Payments</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div class="grid grid-cols-1 lg:grid-cols-5 gap-5">
                            <div class="bg-white dark:bg-dark dark:border-gray/20 border-2 border-lightgray/10 p-5 rounded-lg lg:col-span-3">
                                <div class="flex sm:items-center gap-2.5">
                                    <img src="assets/images/account-profile.png" class="h-[58px] rounded-full" alt="">
                                    <div class="space-y-2">
    ...
    <script>
        var userchart = {
            ...
            colors: ["#267DFF", "#7B6AFE", "#FF51A4", "#FF7C51", "#00D085", "#FFC41F", "#FF3232"],
            plotOptions: {
                bar: {
                    columnWidth: "20%",
                    distributed: true,
            ...
            xaxis: {
                ...
                categories: ["Phones", "Laptops", "Headsets", "Keyboards", "Clothes", "Speakers", "Air buds"],
                labels: {
                    style: {
                        fontSize: "16px",
                        fontWeight: "600",
