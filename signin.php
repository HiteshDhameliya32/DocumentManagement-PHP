...
// Start the session and output buffering at the very beginning of the script
session_start();
        ...
        <div class="relative">
            <div class="md:p-10 p-6 flex items-center justify-center sm:justify-between w-full flex-wrap gap-5">
                <a href="index.php" class="main-logo">
                    <img src="assets/images/logo-dark.svg" class="dark-logo h-8 logo dark:hidden" alt="logo" />
                    <img src="assets/images/logo-light.svg" class="light-logo h-8 logo hidden dark:block" alt="logo" />
                </a>
            ...
            <div class="min-h-[calc(100vh-192px)] p-7 flex justify-center items-center">
                <div
                    ...
                    <form class="mt-[60px] space-y-5" method="post" action="">
                        <div class="relative">
                        ...
                        <div class="relative">
                            ...
                            <span class="toggle-password text-primary absolute right-5 top-1/2 -translate-y-1/2"
                                onclick="togglePasswordVisibility('password')">
                                <!-- Eye icon when password is visible -->
                                <svg id="eyeIconpassword" width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path opacity="0.3"
                                ...
                                <svg id="eyeSlashIconpassword" style="display: none;" width="24" height="24"
                                    ...
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                        d="M8.25 12C8.25 9.92893 9.92893 8.25 12 8.25C14.0711 8.25 15.75 9.92893 15.75 12C15.75 14.0711 14.0711 15.75 12 15.75C9.92893 15.75 8.25 14.0711 8.25 12ZM9.75 12C9.75 10.7574 10.7574 9.75 12 9.75C13.2426 9.75 14.25 10.7574 14.25 12C14.25 13.2426 13.2426 14.25 12 14.25C10.7574 14.25 9.75 13.2426 9.75 12Z"
                                        fill="currentColor"></path>
                                    <path d="M5.929 5.929L18.071 18.071" stroke="currentColor" stroke-width="2"
                        ...
                        <div class="relative">
                            ...
                            <span class="toggle-password text-primary absolute right-5 top-1/2 -translate-y-1/2"
                                ...
                                <!-- Eye icon when password is visible -->
                                <svg id="eyeIconconfirm_password" width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path opacity="0.3"
                                        d="M2 12C2 13.6394 2.42496 14.1915 3.27489 15.2957C4.97196 17.5004 7.81811 20 12 20C16.1819 20 19.028 17.5004 20.7251 15.2957C21.575 14.1915 22 13.6394 22 12C22 10.3606 21.575 9.80853 20.7251 8.70433C19.028 6.49956 16.1819 4 12 4C7.81811 4 4.97196 6.49956 3.27489 8.70433C2.42496 9.80853 2 10.3606 2 12Z"
                                        fill="currentColor"></path>
                                ...
                                <!-- Eye slash icon when password is hidden -->
                                <svg id="eyeSlashIconconfirm_password" style="display: none;" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path opacity="0.3"
                                        d="M2 12C2 13.6394 2.42496 14.1915 3.27489 15.2957C4.97196 17.5004 7.81811 20 12 20C16.1819 20 19.028 17.5004 20.7251 15.2957C21.575 14.1915 22 13.6394 22 12C22 10.3606 21.575 9.80853 20.7251 8.70433C19.028 6.49956 16.1819 4 12 4C7.81811 4 4.97196 6.49956 3.27489 8.70433C2.42496 9.80853 2 10.3606 2 12Z"
                                        fill="currentColor"></path>
