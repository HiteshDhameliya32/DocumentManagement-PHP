...
<html lang="en">
    ...
    <?php $activeMenu = 'userprofile'; $activeItem = 'userprofile';?>
                                    ...
                                    <div class="w-full flex flex-col flex-1 rounded-lg overflow-y-auto h-[calc(100vh-188px)] sm:h-[calc(100vh-204px)]">
                                        ...
                                        <div class="mt-[30px]">
                                            <div class="flex flex-wrap items-center gap-5 p-5 border-2 border-gray/[0.14] rounded-lg" style="background: linear-gradient(90.17deg, rgba(48, 154, 252, 0.1) -3.08%, rgba(87, 84, 255, 0.1) 31.4%, rgba(255, 81, 164, 0.1) 65.89%, rgba(255, 124, 81, 0.1) 100.37%);">
                                                <img src="assets/images/profile-user.png" class="shrink-0 rounded-full" alt="">
                                        ...
                                        <form class="mt-5 grid grid-cols-1 sm:grid-cols-2 gap-5">
                                            <input type="text" id="full-name" class="form-input rounded-[10px] h-14 placeholder:text-dark dark:placeholder:text-white" placeholder="Full Name" required="">
                                            <input type="email" id="email1" class="form-input rounded-[10px] h-14 placeholder:text-dark dark:placeholder:text-white" placeholder="Email" required="">
                                            <input type="password" id="password" class="form-input rounded-[10px] h-14 placeholder:text-dark dark:placeholder:text-white" placeholder="Password" required="">
                                            <input type="password" id="confirm-password" class="form-input rounded-[10px] h-14 placeholder:text-dark dark:placeholder:text-white" placeholder="Confirm password" required="">
                                            <div class="flex items-stretch gap-5">
                                                ...
                                                <input type="text" id="phone-number" class="form-input rounded-[10px] h-14 placeholder:text-dark dark:placeholder:text-white" placeholder="Phone number" required="">
                                            </div>
                                            <input type="date" id="date-of-birth" class="form-input rounded-[10px] h-14 placeholder:text-dark dark:placeholder:text-white" placeholder="Date of birth" required="">
                                            ...
                                            <input type="text" id="state" class="form-input rounded-[10px] h-14 placeholder:text-dark dark:placeholder:text-white" placeholder="State" required="">
                                            <input type="number" id="zip-code" class="form-input rounded-[10px] h-14 placeholder:text-dark dark:placeholder:text-white" placeholder="Zip code" required="">
                                            <input type="text" id="country1" class="form-input rounded-[10px] h-14 placeholder:text-dark dark:placeholder:text-white" placeholder="Country" required="">
