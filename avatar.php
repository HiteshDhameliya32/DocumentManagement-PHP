...
<?php $activeMenu = 'elements'; $activeItem = 'avatar'?>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            <div class="bg-white dark:bg-dark dark:border-gray/20 border-2 border-lightgray/10 p-5 rounded-lg">
                                ...
                                <div class="flex flex-wrap items-center gap-5">
                                    <img src="assets/images/avatar-9.png" class="h-24 w-24 flex-none rounded-full object-cover" alt="avatar">
                                    <img src="assets/images/avatar-10.png" class="h-20 w-20 flex-none rounded-full object-cover" alt="avatar">
                                    <img src="assets/images/avatar-11.png" class="h-16 w-16 flex-none rounded-full object-cover" alt="avatar">
                                    <img src="assets/images/avatar-12.png" class="h-12 w-12 flex-none rounded-full object-cover" alt="avatar">
                                    <img src="assets/images/avatar-13.png" class="h-10 w-10 flex-none rounded-full object-cover" alt="avatar">
                                </div>
                            </div>
                            <div class="bg-white dark:bg-dark dark:border-gray/20 border-2 border-lightgray/10 p-5 rounded-lg">
                                <h2 class="text-base font-semibold mb-4">Avatar Square</h2>
                                <div class="flex flex-wrap items-center gap-5">
                                    <img src="assets/images/avatar-19.png" class="h-24 w-24 flex-none rounded-md object-cover" alt="avatar">
                                    <img src="assets/images/avatar-20.png" class="h-20 w-20 flex-none rounded-md object-cover" alt="avatar">
                                    <img src="assets/images/avatar-21.png" class="h-16 w-16 flex-none rounded-md object-cover" alt="avatar">
                                    <img src="assets/images/avatar-22.png" class="h-12 w-12 flex-none rounded-md object-cover" alt="avatar">
                                    <img src="assets/images/avatar-23.png" class="h-10 w-10 flex-none rounded-md object-cover" alt="avatar">
                                </div>
                            </div>
                            <div class="bg-white dark:bg-dark dark:border-gray/20 border-2 border-lightgray/10 p-5 rounded-lg">
                            ...
                            <div class="bg-white dark:bg-dark dark:border-gray/20 border-2 border-lightgray/10 p-5 rounded-lg">
                                ...
                                <div class="flex items-center justify-start -space-x-4">
                                    ...
                                    <img src="assets/images/avatar-10.png" class="h-10 w-10 flex-none rounded-full ring-2 ring-lightgray/10 dark:ring-gray/20 object-cover" alt="avatar">
                                    <img src="assets/images/avatar-11.png" class="h-10 w-10 flex-none rounded-full ring-2 ring-lightgray/10 dark:ring-gray/20 object-cover" alt="avatar">
                            ...
                            <div class="bg-white dark:bg-dark dark:border-gray/20 border-2 border-lightgray/10 p-5 rounded-lg">
                                ...
                                <div class="flex items-center space-x-2">
                                    <img class="w-10 h-10 rounded-full" src="assets/images/avatar-1.png" alt="">
                                    <div>
                            ...
                            <div class="bg-white dark:bg-dark dark:border-gray/20 border-2 border-lightgray/10 p-5 rounded-lg">
                                ...
                                <div class="flex flex-wrap items-center gap-5">
                                    <img src="assets/images/avatar-9.png" class="h-16 w-16 flex-none border border-primary p-1 rounded-full object-cover" alt="avatar">
                                    <img src="assets/images/avatar-10.png" class="h-16 w-16 flex-none border border-purple p-1 rounded-full object-cover" alt="avatar">
                                    <img src="assets/images/avatar-11.png" class="h-16 w-16 flex-none border border-success p-1 rounded-full object-cover" alt="avatar">
                                    <img src="assets/images/avatar-12.png" class="h-16 w-16 flex-none border border-warning p-1 rounded-full object-cover" alt="avatar">
                                    <img src="assets/images/avatar-13.png" class="h-16 w-16 flex-none border border-danger p-1 rounded-full object-cover" alt="avatar">
                                    <img src="assets/images/avatar-14.png" class="h-16 w-16 flex-none border border-dark dark:border-white p-1 rounded-full object-cover" alt="avatar">
                                    <img src="assets/images/avatar-15.png" class="h-16 w-16 flex-none border dark:border-gray/20 border-lightgray/10 p-1 rounded-full object-cover" alt="avatar">
                                </div>
                            </div>
                        </div>
                    </div>
