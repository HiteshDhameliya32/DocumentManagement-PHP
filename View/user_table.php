                ...
                <tr class="text-left">
                    ...
                    <th>
                        <div class="flex items-center justify-between gap-2">
                            <p>Email</p>
                            <div class="flex flex-col">
                                <svg stroke-linecap="round" stroke-linejoin="round" stroke-width="4" viewBox="0 0 24 24"
                ...
                <template x-for="user in users" :key="user.user_id">
                    <tr x-data="{ editing: false, userRole: user.user_role }">
                        ...
                        <td>
                            ...
                            <input x-show="editing" x-ref="email" type="text" class="form-input" x-model="user.email"
