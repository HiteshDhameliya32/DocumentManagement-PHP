...
<body x-data="main" class="font-inter text-base antialiased font-medium relative vertical" :class="[ $store.app.sidebar ? 'toggle-sidebar' : '', $store.app.fullscreen ? 'full' : '',$store.app.mode]">
    ...
    <!--..:: Start Layout ::..-->
    <div class="min-h-screen bg-white dark:bg-dark text-dark dark:text-white">
        <!--..:: Start Content ::..-->
        <div class="relative">
            <div class="md:p-10 p-6 flex items-center justify-center sm:justify-between w-full flex-wrap gap-5">
                ...
                <div class="flex items-center gap-5">
                    ...
                    <a href="index.php" class="rounded-lg capitalize flex items-center py-4 px-5 gap-2.5 bg-dark text-white dark:bg-white dark:text-dark">
            ...
            <div class="min-h-[calc(100vh-216px)] p-7 flex justify-center items-center">
                <div class="text-center">
                    ...
                    <img src="assets/images/404-light.png" class="lg:mt-32 sm:mt-16 mt-14 dark:hidden" alt="">
                    <img src="assets/images/404-dark.png" class="lg:mt-32 sm:mt-16 mt-14 hidden dark:block" alt="">
                </div>
            </div>
