...
<?php $activeMenu = 'tables'; $activeItem = 'table-basic'?>
                                    ...
                                    <table class="min-w-[640px] w-full product-table">
                                        ...
                                        <tbody>
                                            <tr class="text-left">
                                                ...
                                                <td>
                                                    <div class="flex items-center gap-2.5">
                                                        <img src="assets/images/assets/1.png" class="w-[50px] rounded-full" alt="">
                                            ...
                                            <tr class="text-left">
                                                ...
                                                <td>
                                                    <div class="flex items-center gap-2.5">
                                                        <img src="assets/images/assets/2.png" class="w-[50px] rounded-full" alt="">
                                            ...
                                            <tr class="text-left">
                                                ...
                                                <td>
                                                    <div class="flex items-center gap-2.5">
                                                        <img src="assets/images/assets/3.png" class="w-[50px] rounded-full" alt="">
                                            ...
                                            <tr class="text-left">
                                                ...
                                                <td>
                                                    <div class="flex items-center gap-2.5">
                                                        <img src="assets/images/assets/4.png" class="w-[50px] rounded-full" alt="">
