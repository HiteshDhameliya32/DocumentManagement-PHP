                        ...
                        <div class="grid grid-cols-1">
                            <div>
                                <ul class="font-semibold text-lightgray flex items-center gap-4 sm:gap-[30px] gap-y-4 whitespace-nowrap overflow-auto">
                                    <li>
                                        <a href="ecommerce.php" class="hover:text-dark duration-300 dark:hover:text-white">Overview</a>
                                    </li>
                                    <li>
                                        <a href="order-list.php" class="hover:text-dark duration-300 dark:hover:text-white">Order List</a>
                                    </li>
                                    <li>
                                        <a href="accounts.php" class="hover:text-dark duration-300 dark:hover:text-white">Accounts</a>
                                    </li>
                                    <li>
                                        <a href="payment.php" class="text-dark dark:text-white duration-300">Payments</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                                    ...
                                    <div>
                                        ...
                                        <ul class="mt-5 space-y-[22px]">
                                            <li>
                                                <a href="#" class="flex items-center gap-2.5">
                                                    <div class="w-9 h-9 bg-primary/10 rounded-full flex items-center justify-center shrink-0">
                                                        <img src="assets/images/avatar-1.png" class="rounded-full" alt="">
                                                    </div>
                                                    <div>
                                            ...
                                            <li>
                                                <a href="#" class="flex items-center gap-2.5">
                                                    <div class="w-9 h-9 bg-purple/10 rounded-full flex items-center justify-center shrink-0">
                                                        <img src="assets/images/avatar-2.png" class="rounded-full" alt="">
                                                    </div>
                                                    <div>
                                ...
                                <div class="space-y-5">
                                    <div class="flex items-center gap-2.5 justify-between">
                                        <div class="flex items-center gap-3.5">
                                            <img src="assets/images/avatar-4.png" class="h-10 rounded-full" alt="">
                                    ...
                                    <div class="flex items-center gap-2.5 justify-between">
                                        <div class="flex items-center gap-3.5">
                                            <img src="assets/images/avatar-5.png" class="h-10 rounded-full" alt="">
                                            <div class="space-y-1.5">
                                    ...
                                    <div class="flex items-center gap-2.5 justify-between">
                                        <div class="flex items-center gap-3.5">
                                            <img src="assets/images/avatar-6.png" class="h-10 rounded-full" alt="">
                                            <div class="space-y-1.5">
                                    ...
                                    <div class="flex items-center gap-2.5 justify-between">
                                        <div class="flex items-center gap-3.5">
                                            <img src="assets/images/avatar-7.png" class="h-10 rounded-full" alt="">
                                            <div class="space-y-1.5">
                                    ...
                                    <div class="flex items-center gap-2.5 justify-between">
                                        <div class="flex items-center gap-3.5">
                                            <img src="assets/images/avatar-8.png" class="h-10 rounded-full" alt="">
                                            <div class="space-y-1.5">
